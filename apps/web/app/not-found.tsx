...
export default function NotFound() {
  return (
    <div className="border border-line rounded-[8px] p-8 md:p-12 flex flex-col gap-4 items-start ticks">
      ...
      <p className="text-ink-secondary max-w-[48ch]">Nothing lives at this address. Only tokens launched through the launchpad factory are listed, identified by contract address.</p>
