...
const FAQ = [
  ...
  ['How do I get NVDAc or another stock token?', 'Buy it on Base through Coinbase or any Base DEX; base.org/stocks lists the venues. Coinbase tokenized stocks are available only to eligible persons outside the United States.'],
